...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=RentCarSystem;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ApprovalRequest>(entity =>
        {
            ...
            entity.HasIndex(e => e.BsnId, "UQ__Approval__240DA66D8543292C").IsUnique();
        ...
        modelBuilder.Entity<Business>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "UQ__Business__1788CCADE19143EE").IsUnique();

            entity.HasIndex(e => e.Description, "UQ__Business__4EBBBAC998FC029B").IsUnique();
        ...
        modelBuilder.Entity<Car>(entity =>
        {
            ...
            entity.HasIndex(e => e.VehicleId, "UQ__Car__476B54B36192A858").IsUnique();
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "UQ__Customer__1788CCAD7CBECC93").IsUnique();
        ...
        modelBuilder.Entity<Individual>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "UQ__Individu__1788CCAD14103C3B").IsUnique();
        ...
        modelBuilder.Entity<Motor>(entity =>
        {
            ...
            entity.HasIndex(e => e.VehicleId, "UQ__Motor__476B54B3934223EF").IsUnique();
            ...
            entity.Property(e => e.MotorcycleType).HasMaxLength(100);
            entity.Property(e => e.VehicleId)
                .HasMaxLength(32)
                .IsUnicode(false)
                .HasColumnName("VehicleID");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasIndex(e => e.PhoneNumber, "UQ__User__85FB4E38B1464643").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__User__A9D10534DCBC1E20").IsUnique();
        ...
        modelBuilder.Entity<VehicleHireService>(entity =>
        {
            ...
            entity.HasIndex(e => e.BankAccount, "UQ__Vehicle___D70583E0700F5BF4").IsUnique();
